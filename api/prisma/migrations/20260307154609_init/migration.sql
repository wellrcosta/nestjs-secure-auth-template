...
-- CreateEnum
CREATE TYPE "AuditAction" AS ENUM ('AUTH_REGISTER', 'AUTH_LOGIN', 'AUTH_REFRESH', 'AUTH_LOGOUT', 'AUTH_LOGOUT_ALL', 'SESSION_REVOKE', 'PASSWORD_CHANGE');
...
-- CreateIndex
CREATE INDEX "User_emailNorm_idx" ON "User"("emailNorm");
